...
describe Coin2Coin::Bitcoin do
  ...
  describe "address_for_public_key!" do
    subject { Coin2Coin::Bitcoin.instance.address_for_public_key!(public_key_hex) }
  ...
  describe "public_key_for_private_key!" do
    subject { Coin2Coin::Bitcoin.instance.public_key_for_private_key!(private_key_hex) }
  ...
  describe "verify_address!" do
    subject { Coin2Coin::Bitcoin.instance.verify_address!(address) }
